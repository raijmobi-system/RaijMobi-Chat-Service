...
SECRET_KEY = 'django-insecure-d37hm%qql$fli!_ml^(uznop#m*&(-15qjzgb^y3(6)a-#6x+0'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'raijmobi_chat_db'),
        'USER': os.environ.get('DB_USER', 'raijmobi_chat'),
